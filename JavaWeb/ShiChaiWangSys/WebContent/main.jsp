			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			  <div class="container">
				<div class="navbar-header">
				  <a class="navbar-brand" href="index.jsp" style="font-size:32px;">拾柴网项目众筹平台</a>
				</div>
            <div id="navbar" class="navbar-collapse collapse" style="float:right;">
              <ul class="nav navbar-nav navbar-right">
                <li><a href="userInfo.jsp"><c:out value="${user.username }"></c:out></a></li>
				<li><a>|</a></li>
				<li><a href="adminLogin.jsp">管理员入口</a></li>
              </ul>
            </div>
			  </div>
			</nav>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="project.jsp" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
