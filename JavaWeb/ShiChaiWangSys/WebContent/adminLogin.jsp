    ...
    <div class="container">
      ...
      <form class="form-signin" role="form" action="adminLogin" method="post">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 管理员登录</h2>
		  ...
		  <div class="form-group has-success has-feedback">
			<input type="password" name="password" class="form-control" id="inputSuccess4" placeholder="请输入登录密码" style="margin-top:10px;">
			<span class="glyphicon glyphicon-lock form-control-feedback"></span>
		  </div>
        <input type="submit" class="btn btn-lg btn-success btn-block" value="登录"/>
        <div><span><img src="img/shichai.png"></span></div>
      </form>
    </div>
